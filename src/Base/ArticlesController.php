...
class ArticlesController extends BaseController
{
    ...
    public function register()
    {
        ...
        if ( ! $this->activated( 'example_articles' ) ) return;
        ...
        add_shortcode( 'example-articles', [$this, 'articles_front'] );
    }
    ...
    public function articles_front()
    {
        ob_start();

        /*Si on veut ajouter du css exlusif à la page front.
        Ne pas oublier de créer le fichier à l'emplacement désigné*/
        echo "<link rel=\"stylesheet\"  href=\"$this->plugin_url/assets/css/example-articles.css\"></link>";

        require_once( "$this->plugin_path/templates/articles-front.php" );
    ...
    public function setSubpages(){
        $this->subpages = [
            [
                ...
                'page_title' => 'Articles',             //titre de la page
                'menu_title' => 'Articles',             //titre de la page
                'capability' => 'manage_options',
                'menu_slug' => 'example_articles',      //slug de la sous-page en question
                'callback' => [$this->callbacks, 'adminArticles'] //Appelle une fonction dans AdminCallback.php pour afficher la page php de la sous page
            ]
        ];
    }
}